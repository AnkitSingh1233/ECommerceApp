...
import in.nareshit.ankit.entity.Orders;
import in.nareshit.ankit.entity.UserRegister;
import in.nareshit.ankit.model.OrderModuleDto;
import in.nareshit.ankit.repository.OrderModuleRepo;
import in.nareshit.ankit.repository.UserRegisterRepo;
import in.nareshit.ankit.service.OrderService;
...
public class OrderServiceImpl implements OrderService{
	...
	public String saveOrders(OrderModuleDto orderModuleDto) {
		...
		for (String title : seletedBooks) {
			...
			Book bookName = orderModuleRepo.findByBookName(title);
